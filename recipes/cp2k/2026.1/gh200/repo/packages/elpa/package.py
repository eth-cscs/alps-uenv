...
class Elpa(AutotoolsPackage, CudaPackage, ROCmPackage):
    ...
    version(
        "2025.06.001",
        sha256="feeb1fea1ab4a8670b8d3240765ef0ada828062ef7ec9b735eecba2848515c94",
    )
    version(
        "2025.01.002",
        sha256="8febe408c590ba9b44bd8bce04605fd1b7da964afcd8fd5f1ce9edecb3d0b65d",
    )
    version(
        "2025.01.001",
        sha256="3ef0c6aed9a3e05db6efafe6e14d66eb88b2a1354d61e765b7cde0d3d5f3951e",
    )
    version(
        "2024.05.001",
        sha256="9caf41a3e600e2f6f4ce1931bd54185179dade9c171556d0c9b41bbc6940f2f6",
    )
    version(
        "2024.03.001",
        sha256="41c6cbf56d2dac26443faaba8a77307d261bf511682a64b96e24def77c813622",
    )
    version(
        "2023.11.001-patched",
    ...
    version(
        "2023.05.001",
        sha256="ec64be5d6522810d601a3b8e6a31720e3c3eb4af33a434d8a64570d76e6462b6",
    )
    version(
        "2022.11.001",
        sha256="75db3ac146f9a6a1598e3418ddcab2be2f40a30ef9ec4c00a3b5d3808c99c430",
    )
    version(
        "2021.11.001",
    ...
    with when("+openmp"):
        ...
        requires(
            ...
            when="^[virtuals=blas,lapack] intel-oneapi-mkl",
        )
    ...
    def configure_args(self):
        ...
        ldflags = [
            spec["blas"].libs.search_flags,
            spec["lapack"].libs.search_flags,
            "-lstdc++",
        ]
