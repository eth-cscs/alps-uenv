...
class Nccl(MakefilePackage, CudaPackage):
    ...
    patch(
        #"https://github.com/NVIDIA/nccl/pull/1979.patch?full_index=1",
        #sha256="4bd0a7aed0721b4a72c483357ac579be5e05eea6193782dcebfb63415a426aa0",
        #"https://github.com/NVIDIA/nccl/pull/1979.patch",
        #sha256="1541aaf0912eee0aca3d33b3eb8d465028155361dadb264961b985db0c9eb8b4",
        "net.cc.patch",
        when="@2.28:",
    )
