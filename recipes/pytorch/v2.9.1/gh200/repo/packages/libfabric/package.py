...
class Libfabric(AutotoolsPackage, CudaPackage, ROCmPackage):
    ...
    version("2.4.0-dev", commit="f8262817c337d615a1acceea6cd4ecb526ce548b")
    ...
    depends_on("autoconf", type="build", when="@2.4.0-dev build_system=autotools")
    depends_on("automake", type="build", when="@2.4.0-dev build_system=autotools")
    depends_on("libtool", type="build", when="@2.4.0-dev build_system=autotools")
